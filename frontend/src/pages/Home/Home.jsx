...
function Home() {
  ...
  const getAllNotes = async ()=>{
    try {
        const res = await axios.get("https://note-tq28.onrender.com/api/note/all",{withCredentials:true})
  ...
  const deleteNote =async(data)=>{
    ...
    try {
      const res= await axios.delete("https://note-tq28.onrender.com/api/note/delete/"+ noteId ,{withCredentials:true})
  ...
  const onSearchNote =async (query)=>{
    try {
      const res =await axios.get("https://note-tq28.onrender.com/api/note/search",{params: {query},
  ...
  const updateIsPinnded =async(noteData)=>{
    ...
    try {
      const res= await axios.put("https://note-tq28.onrender.com/api/note/update-note-pinned/"+noteId,{isPending: !noteData.isPinned},{withCredentials:true})
